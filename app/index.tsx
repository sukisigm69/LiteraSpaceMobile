...
const availableBooks: Book[] = [
  { 
    ...
    rating: 4.7,
    coverImage: { uri: 'https://via.placeholder.com/150x200/3498db/ffffff?text=Book1' }
  },
  { 
    id: '2', 
    title: 'Journal 3', 
    author: 'Rob Renzetti', 
    rating: 5.0,
    coverImage: { uri: 'https://via.placeholder.com/150x200/2ecc71/ffffff?text=Book2' }
  },
  { 
    id: '3', 
    title: 'Book Of Bill', 
  ...
  { 
    ...
    rating: 4.8,
    coverImage: { uri: 'https://via.placeholder.com/150x200/9b59b6/ffffff?text=Book4' }
  },
];
...
const favoriteBooks: Book[] = [
  { 
    ...
    author: 'Ben Bocquelet', 
    rating: 4.7,
    coverImage: { uri: 'https://via.placeholder.com/150x200/3498db/ffffff?text=Favorite' },
    isFavorite: true 
  },
];
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        ...
        >
          <Ionicons name="search" size={24} color="#95a5a6" />
        ...
        >
          <Ionicons name="bookmark" size={24} color="#95a5a6" />
          <Text style={styles.navItemText}>Collection</Text>
        </TouchableOpacity>
        <TouchableOpacity 
          style={styles.navItem}
          onPress={navigateToProfile}
